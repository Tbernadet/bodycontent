...
var _messages = {
    common: {
        element: 'apibodycontent',
        usage  : '@apibodycontent (group) varname',
        example: '@apiDefine MyValidBodycontentGroup Some title\n@apibodycontent (MyValidBodycontentGroup) username'
    }
};
...
function preProcess(parsedFiles, filenames, packageInfos, target) {
    target = target || 'defineBodycontentTitle';
...
function postProcess(parsedFiles, filenames, preProcess, packageInfos, source, target, messages) {
    source = source || 'defineBodycontentTitle';
    target = target || 'bodycontent';
    ...
    parsedFiles.forEach(function(parsedFile, parsedFileIndex) {
        parsedFile.forEach(function(block) {
            ...
            Object.keys(fields).forEach(function(fieldGroup) {
                var bodycontent = block.local[target].fields[fieldGroup];

                bodycontent.forEach(function(definition) {
